...
for m in MONTH_LIST:
    ...
    GDB = r"A:\TEST_LOCATION\03 PROGRAMMING\0008_IRRIGATION_USAGE\OUTPUT_GDB"
        
    arcpy.management.Delete(os.path.join(GDB, CURRENT_MONTH + YEAR + ".gdb", "IRRIGATION_USAGE_" + MONTH + YEAR))
        
        
        ### CONVERT TABLE TO GDB ###
        # table = r"A:\GIS\01 PROJECTS\906 IRRIGATION USAGE MAP\01 DATA\00 GIS\IRRIGATION.gdb\D14_MATCHES"
    arcpy.conversion.ExcelToTable(r"A:\TEST_LOCATION\03 PROGRAMMING\0008_IRRIGATION_USAGE\OUTPUT_TABLES" + "\\"+ CURRENT_MONTH + YEAR + "\\" + "IRRIGATION_USAGE_" + MONTH + YEAR + ".xlsx",
                                    os.path.join(GDB, CURRENT_MONTH + YEAR + ".gdb", "IRRIGATION_USAGE_" + MONTH + YEAR))