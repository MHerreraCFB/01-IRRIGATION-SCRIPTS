...
for m in MONTH_LIST:
    ...
    #CLEAR GDB BEFORE USE   
    arcpy.management.Delete(os.path.join(GDB, CURRENT_MONTH + YEAR + ".gdb", "IRRIGATION_USAGE_" + MONTH + YEAR))
        
        
    ### CONVERT TABLE TO GDB ###
    arcpy.conversion.ExcelToTable(r"A:\GIS\01 PROJECTS\906 IRRIGATION USAGE MAP\02 DELIVERABLES\01 MONTHLY RESULTS\RESIDENTIAL_TABLES" + "\\"+ CURRENT_MONTH + YEAR + "\\" + "IRRIGATION_USAGE_" + MONTH + YEAR + ".xlsx",
